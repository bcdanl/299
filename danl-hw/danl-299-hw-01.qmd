---
title: Homework 1
subtitle: Personal Website and Python Basics
date: 2025-09-11
from: markdown+emoji
execute: 
  eval: false
...
- Please submit your **Jupyter Notebook** for **Part 2 in Homework 1** to Brightspace with the name below:
...
4. Add a "Python Basics" blog post to your blog using **Jupyter Notebook**.
  - In your "Python Basics" blog post, briefly explain Python Basics we discussed in [Lecture 4](https://bcdanl.github.io/299/danl-lec/danl-299-lec-04-2025-0908.html) and [Lecture 5](https://bcdanl.github.io/299/danl-lec/danl-299-lec-05-2025-0910.html), and in [Classwork 4](https://bcdanl.github.io/299/danl-cw/danl-299-cw-04.html)
